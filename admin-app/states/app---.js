...
function() {
    ...
    function e(e, a, t, o, n) {
        ...
        function() {
            ...
            var a;
            r.handle_filetree = function(o) {
                a = o;
                var n = !!o.children.length;
                console.log("You selected: " + o.label + " - isFolder? " + n), n || t.get("server/editor/" + o.path).then(function(a) {
                    console.log("Loaded.. " + o.path), r.code = a.data, r.editorOpts.mode = e(o.path), console.log("Mode is: " + r.editorOpts.mode)
                })
            };
            var i;
            i = r.filetree = {}, r.new_filetree = function() {
                var e;
                return e = i.get_selected_branch(), e && 0 === e.children.length && (e = i.get_parent_branch(e)), i.add_branch(e, {
                    label: "another.html",
    ...
    angular.module("app.extras").controller("CodeEditorController", e), e.$inject = ["$rootScope", "$scope", "$http", "$ocLazyLoad", "filetree"]
}(),
function() {
    "use strict";
    ...
    function e(e) {
        ...
        ! function() {
            a.items = [{
                ...
                complete: !1
            }], a.editingTodo = !1, a.todo = {}, a.addTodo = function() {
                "" !== a.todo.title && (a.todo.description || (a.todo.description = ""), a.editingTodo ? (a.todo = {}, a.editingTodo = !1) : (a.items.push({
                    todo: angular.copy(a.todo),
                    complete: !1
                }), a.todo.title = "", a.todo.description = ""))
            }, a.editTodo = function(e, t) {
                t.preventDefault(), t.stopPropagation(), a.todo = a.items[e].todo, a.editingTodo = !0
            }, a.removeTodo = function(e) {
                a.items.splice(e, 1)
            }, a.clearAll = function() {
                a.items = []
            }, a.totalCompleted = function() {
                return e("filter")(a.items, function(e) {
                    return e.complete
                }).length
            }, a.totalPending = function() {
                return e("filter")(a.items, function(e) {
                    return !e.complete
                }).length
            }
    ...
    angular.module("app.extras").controller("TodoController", e), e.$inject = ["$filter"]
}(),
function() {
    "use strict";
    ...
    angular.module("app.extras").controller("WordCloudController", e)
}(),
function() {
    "use strict";
    ...
    function e() {
        function e(e, a, t) {
            ...
            var o, n = $("html, body"),
                r = $(document).on("flatdoc:ready", function() {
                    var e = $('[role="flatdoc-menu"]');
                    o = e.find("a").on("click", function(a) {
                        a.preventDefault(), a.stopPropagation();
                        var t = $(this);
                        e.find("a.active").removeClass("active"), t.addClass("active"), n.animate({
                            scrollTop: $(this.getAttribute("href")).offset().top - ($(".topnavbar").height() + 10)
                        }, 800)
                    })
                });
            e.$on("$destroy", function() {
                o && o.off(), r.off("flatdoc:ready")
            })
        }
        return {
    ...
    angular.module("app.flatdoc").directive("flatdoc", e)
}(),
function() {
    "use strict";
    ...
    function e() {
        ...
        ! function() {
            e.hexPicker = {
                ...
                color: ""
            }, e.resetColor = function() {
                e.hexPicker = {
                    color: "#ff0000"
                }
            }, e.resetRBGColor = function() {
                e.rgbPicker = {
                    color: "rgb(255,255,255)"
                }
            }, e.resetRBGAColor = function() {
                e.rgbaPicker = {
                    color: "rgb(255,255,255, 0.25)"
                }
            }, e.resetNonInputColor = function() {
                e.nonInput = {
                    color: "#ffffff"
                }
            }
    ...
    angular.module("app.forms").controller("ColorPickerController", e)
}(),
function() {
    "use strict";
    ...
    angular.module("app.forms").directive("filestyle", e)
}(),
function() {
    "use strict";
    ...
    function e(e) {
        ...
        ! function() {
            a.reset = function() {
                a.myImage = "", a.myCroppedImage = "", a.imgcropType = "square"
            }, a.reset();
            var t = function(t) {
                ...
                n.onload = function(t) {
                    e.$apply(function() {
                        a.myImage = t.target.result
                    })
                }, o && n.readAsDataURL(o)
            };
            angular.element(document.querySelector("#fileInput")).on("change", t)
        }()
    }
    angular.module("app.forms").controller("ImageCropController", e), e.$inject = ["$scope"]
}(),
function() {
    "use strict";
    ...
    function e() {
        ...
        ! function() {
            e.notBlackListed = function(e) {
                return -1 === ["some@mail.com", "another@email.com"].indexOf(e)
            }, e.words = function(e) {
                ...
                if (e.submitted = !0, !e.formValidate.$valid) return console.log("Not valid!!"), !1;
                console.log("Submitted!!")
            }
        }()
    }
    angular.module("app.forms").controller("FormValidationController", e)
}(),
function() {
    "use strict";
        ...
        function o(e, a, t) {
            ...
            o.quantity = parseInt(e, 10), o.validate = a, o.element = t, o.init = function() {
                ...
                if (angular.isDefined(o.steps[e])) {
                    if (o.validate && 1 !== e) {
                        var a = o.element.scope();
                        if ("function" == typeof a.wizardValidate) {
                            var t = $(o.element).children().children("div").eq(e - 2).children("[ng-form]");
                            if (!a.wizardValidate(t.attr("ng-form"))) return !1
                        }
                    }
    ...
    function a(e) {
        e.wizardValidate = function(a) {
            if (angular.isDefined(e[a])) return e[a].$setSubmitted(!0), e[a].$valid
        }
    }
    angular.module("app.forms").directive("formWizard", e), e.$inject = ["$parse"], a.$inject = ["$scope"]
}(),
function() {
    "use strict";
    ...
    function e(e, a, t, o, n) {
        ...
        r.title = "Controller",
            function() {
                a.theme = "bs3", t.bs3.inputClass = "input-sm", t.bs3.buttonsClass = "btn-sm", t.bs3.submitTpl = '<button type="submit" class="btn btn-success"><span class="fa fa-check"></span></button>', t.bs3.cancelTpl = '<button type="button" class="btn btn-default" ng-click="$form.$cancel()"><span class="fa fa-times text-muted"></span></button>', r.user = {
                    ...
                    value: 4,
                    text: "status4"
                }], r.showStatus = function() {
                    var e = o("filter")(r.statuses, {
                        value: r.user2.status
                    });
                    return r.user2.status && e.length ? e[0].text : "Not set"
                }, r.user3 = {
                    id: 4,
                    text: "admin"
                }, r.groups = [], r.loadGroups = function() {
                    return r.groups.length ? null : n.get("server/xeditable-groups.json").then(function(e) {
                        r.groups = e.data
                    })
                }, e.$watch("user3.id", function(e, a) {
                    if (e !== a) {
                        var t = o("filter")(r.groups, {
                            id: r.user3.id
                        });
                        r.user3.text = t.length ? t[0].text : null
                    }
                }), r.user4 = {
                    state: "Arizona"
                }, r.states = ["Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Mississippi", "Missouri", "Montana", "Nebraska", "Nevada", "New Hampshire", "New Jersey", "New Mexico", "New York", "North Dakota", "North Carolina", "Ohio", "Oklahoma", "Oregon", "Pennsylvania", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Utah", "Vermont", "Virginia", "Washington", "West Virginia", "Wisconsin", "Wyoming"]
            }()
    }
    angular.module("app.forms").controller("FormxEditableController", e), e.$inject = ["$scope", "editableOptions", "editableThemes", "$filter", "$http"]
}(),
function() {
    "use strict";
    ...
    function e(e) {
        ...
        ! function() {
            e("server/cities.json", {}, {
                ...
                a.cities = e
            }), a.slider1 = 5, a.slider2 = 10, a.slider3 = 15, a.slider4 = 20, a.slider5 = 25, a.slider6 = 30, a.slider7 = 10, a.slider8 = [250, 750];
            var t = e("server/chosen-states.json", {}, {
                query: {
                    method: "GET",
                    isArray: !0
                }
            });
            a.states = t.query(), a.alertSubmit = function() {
                return alert("Form submitted!"), !1
            }, a.wysiwygContent = "<p> Write something here.. </p>"
        }()
    }
    angular.module("app.forms").controller("FormDemoCtrl", e), e.$inject = ["$resource"]
}(),
function() {
    "use strict";
    ...
    angular.module("app.forms").directive("masked", e)
}(),
function() {
    "use strict";
    ...
    angular.module("app.forms").filter("propsFilter", e)
}(),
function() {
    "use strict";
    ...
    angular.module("app.forms").directive("tagsinput", e), e.$inject = ["$timeout"]
}(),
function() {
    "use strict";
    ...
    function e(e, a) {
        var t = this;
        ! function() {
            t.disabled = void 0, t.enable = function() {
                t.disabled = !1
            }, t.disable = function() {
                t.disabled = !0
            }, t.clear = function() {
                t.person.selected = void 0, t.address.selected = void 0, t.country.selected = void 0
            }, t.person = {}, t.people = [{
                name: "Adam",
                email: "adam@email.com",
                age: 10
                ...
                email: "adrian@email.com",
                age: 21
            }], t.address = {}, t.refreshAddresses = function(e) {
                if (e) {
                    var o = {
                        address: e
                    };
                    return a.get("//maps.googleapis.com/maps/api/geocode/json", {
                        ...
                        t.addresses = e.data.results
                    })
                }
            }, t.country = {}, t.countries = [{
                name: "Afghanistan",
                code: "AF"
            }, {
                name: "Åland Islands",
